...
== C0SIRENJ ~I have come as you bid me, Talonite. Now I will have answers from you.~
...
== C0SIRENJ ~Who... who are you?~
== C0TSAMON ~My name is T'samon De'bryll Thornhaven... but I presume that name means nothing to you.~
== C0SIRENJ ~T'samon...? You speak as if you know of me, yet neither your name nor your face is familiar. What have I done to earn your hatred?~
== C0TSAMON ~I know much of you, Sirene. After all... we share the same blood, you and I.~
== C0SIRENJ ~You-?! You are...~
== C0TSAMON ~Aye. I am T'samon, son of Lena of the noble house De'Bryll. Our mother.~
== C0SIRENJ ~If what you say is the truth, then why have you called me here? Even if we are siblings, I am a servant of Ilmater, and you of Talona. We are enemies by our faiths alone.~
...
== C0SIRENJ ~'Your vengeance'...? Of what do you speak?~
...
== C0SIRENJ ~Wait, T'samon! There is no cause to do this! Why do you so desperately seek my death?~
...
== C0SIRENJ ~I do not understand. If you are truly my brother, then why... why did you do any of this?~
== C0TSAMON ~Why? Because I desired vengeance. Vengeance for the day our parents died so that you could live.~
== C0SIRENJ ~What are you talking about? Why did they die? Tell me!~
...
== C0SIRENJ ~No... *this* is why you hold such hatred for me?~
...
END
IF ~GlobalGT("C0SireneFaith","GLOBAL",5)~ EXTERN C0SIRENJ a1.1
IF ~!GlobalGT("C0SireneFaith","GLOBAL",5) !GlobalLT("C0SireneFaith","GLOBAL",-5)~ EXTERN C0SIRENJ a1.2
IF ~GlobalLT("C0SireneFaith","GLOBAL",-5)~ EXTERN C0SIRENJ a1.3
...
== C0SIRENJ ~Perhaps you may believe that, but... I pray that this will one day cure your heart of hatred. But if you come to me with the goal of vengeance a second time... then I will satiate your desire for death.~
== C0SIRENJ ~Farewell, T'samon. I hope that when we meet again, I may truly call you brother.~
...
END
IF ~GlobalGT("C0SireneFaith","GLOBAL",-1)~ EXTERN C0SIRENJ a1.4
IF ~GlobalLT("C0SireneFaith","GLOBAL",0)~ EXTERN C0SIRENJ a1.5
...
END
++ ~I can't make this choice for you, Sirene.~ EXTERN C0SIRENJ a1.6
++ ~You said it yourself. If you truly don't believe he deserves death, then you should let him go. I doubt he's a threat to anyone now.~ EXTERN C0SIRENJ a1.7
+ ~!Global("C0SireneRomanceActive","GLOBAL",2)
OR(3)
CheckStatGT(Player1,17,INT)
CheckStatGT(Player1,17,WIS)
CheckStatGT(Player1,17,CHR)~ + ~I think you should execute him. Not only is he a Talonite, but he just tried to kill us. Who's to say he won't try it again?~ EXTERN C0SIRENJ a1.8
+ ~!Global("C0SireneRomanceActive","GLOBAL",2)
CheckStatLT(Player1,18,INT)
CheckStatLT(Player1,18,WIS)
CheckStatLT(Player1,18,CHR)~ + ~I think you should execute him. Not only is he a Talonite, but he just tried to kill us. Who's to say he won't try it again?~ EXTERN C0SIRENJ a1.9
+ ~Global("C0SireneRomanceActive","GLOBAL",2)
OR(3)
CheckStatGT(Player1,14,INT)
CheckStatGT(Player1,14,WIS)
CheckStatGT(Player1,14,CHR)~ + ~I think you should execute him. Not only is he a Talonite, but he just tried to kill us. Who's to say he won't try it again?~ EXTERN C0SIRENJ a1.8
+ ~Global("C0SireneRomanceActive","GLOBAL",2)
CheckStatLT(Player1,15,INT)
CheckStatLT(Player1,15,WIS)
CheckStatLT(Player1,15,CHR)~ + ~I think you should execute him. Not only is he a Talonite, but he just tried to kill us. Who's to say he won't try it again?~ EXTERN C0SIRENJ a1.9
...
END
++ ~I can't make this choice for you, Sirene.~ EXTERN C0SIRENJ a1.6
++ ~You mean you'll forsake your paladinhood if you choose to kill him?~ EXTERN C0SIRENJ a1.12
++ ~You're right. He deserves to die for trying to kill us. Finish him, Sirene.~ EXTERN C0SIRENJ a1.7
+ ~!Global("C0SireneRomanceActive","GLOBAL",2)
OR(3)
CheckStatGT(Player1,13,INT)
CheckStatGT(Player1,13,WIS)
CheckStatGT(Player1,13,CHR)~ + ~No, Sirene. Don't do this. I was forced to kill my brother as well, and it brought me no peace in the end. The cost is too great... you'll regret this for life.~ EXTERN C0SIRENJ a1.10
+ ~!Global("C0SireneRomanceActive","GLOBAL",2)
CheckStatLT(Player1,14,INT)
CheckStatLT(Player1,14,WIS)
CheckStatLT(Player1,14,CHR)~ + ~No, Sirene. Don't do this. I was forced to kill my brother as well, and it brought me no peace in the end. The cost is too great... you'll regret this for life.~ EXTERN C0SIRENJ a1.11
+ ~Global("C0SireneRomanceActive","GLOBAL",2)~ + ~No, Sirene. Don't do this. I was forced to kill my brother as well, and it brought me no peace in the end. The cost is too great... you'll regret this for life.~ EXTERN C0SIRENJ a1.10

CHAIN C0SIRENJ a1.6
~Then... I will trust in my own decision, and do what I believe is right.~
END
IF ~GlobalGT("C0SireneFaith","GLOBAL",-4)~ EXTERN C0SIRENJ a1.1
IF ~GlobalLT("C0SireneFaith","GLOBAL",-3)~ EXTERN C0SIRENJ a1.3

CHAIN C0SIRENJ a1.7
~Aye... there is truth in your words. I know what I must do...~
END
IF ~GlobalGT("C0SireneFaith","GLOBAL",-1)~ EXTERN C0SIRENJ a1.1
IF ~GlobalLT("C0SireneFaith","GLOBAL",0)~ EXTERN C0SIRENJ a1.3

CHAIN C0SIRENJ a1.8
~Perhaps... perhaps you are right.~
EXTERN C0SIRENJ a1.3

CHAIN C0SIRENJ a1.9
~...No, <CHARNAME>. I will not betray Ilmater's teachings, despite my doubts.~
EXTERN C0SIRENJ a1.1

CHAIN C0SIRENJ a1.10
~But... no, you are right. I allowed my judgment to be clouded by my feelings. I should not turn my back on Ilmater for this.~
EXTERN C0SIRENJ a1.1

CHAIN C0SIRENJ a1.11
~Aye, but 'twas it not you whom taught me to make my own choices? I know it in my heart... I cannot allow this man to live.~
EXTERN C0SIRENJ a1.3

CHAIN C0SIRENJ a1.12
...
END
++ ~I see... then I cannot tell you what to do. You must make this decision yourself.~ EXTERN C0SIRENJ a1.6
++ ~Then kill him. If you truly believe that is the right thing to do, then do it.~ EXTERN C0SIRENJ a1.7
+ ~OR(3)
CheckStatGT(Player1,15,INT)
CheckStatGT(Player1,15,WIS)
CheckStatGT(Player1,15,CHR)~ + ~No, Sirene. Don't do this. I was forced to kill my brother as well, and it brought me no peace in the end. The cost is too great... you'll regret this for life.~ EXTERN C0SIRENJ a1.10
+ ~CheckStatLT(Player1,16,INT)
CheckStatLT(Player1,16,WIS)
CheckStatLT(Player1,16,CHR)~ + ~No, Sirene. Don't do this. I was forced to kill my brother as well, and it brought me no peace in the end. The cost is too great... you'll regret this for life.~ EXTERN C0SIRENJ a1.11