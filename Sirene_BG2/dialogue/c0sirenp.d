...
!Global("Chapter","GLOBAL",7)~ + ~Yes, for now.~ + p2a
 	+ ~Global("Chapter","GLOBAL",4)
Global("Chapter","GLOBAL",5)
Global("Chapter","GLOBAL",7)~ + ~Yes, for now.~ + p2b
...
CHAIN IF WEIGHT #-1 ~Global("C0SireneVampire","GLOBAL",4)~ THEN C0SIRENP v1.0
...
== C0SIRENP ~<CHARNAME>? 'Tis not... are you...~
END
++ ~I'm alive, my love. As are you.~ EXTERN C0SIRENP v1.3
++ ~Shh... it's over. Everything's all right.~ EXTERN C0SIRENP v1.3
++ ~(Embrace her)~ EXTERN C0SIRENP v1.2
...
END
IF ~~ EXTERN C0SIRENP v1.3

CHAIN C0SIRENP v1.3
~'Twas not a dream after all, then... I am so relieved.~
== C0SIRENP ~It felt as though 'twas the longest nightmare I have ever had... I had thought myself lost to this, but I was reluctant to pass on... because of you.~
== C0SIRENP ~I can scarce believe it... the darkness felt as though it would last forever. Yet... here I am. You saved me.~
END
++ ~We've won the day, my love. We'll never be parted again.~ EXTERN C0SIRENP v1.4
++ ~I will never allow this to happen again, Sirene. I promise.~ EXTERN C0SIRENP v1.4
++ ~I'm so relieved. But now we should be going.~ EXTERN C0SIRENP v1.5
