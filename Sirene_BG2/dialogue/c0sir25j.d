...
== GORCAMB IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) GlobalGT("Chapter","GLOBAL",7)~ THEN ~Hmm... though perhaps my initial judgment was inaccurate. This one has a distinctly... Baatorian scent about her.~
...
== C0SIR25J IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) GlobalGT("Chapter","GLOBAL",7)~ THEN ~We... we are not alone, <CHARNAME>. I do not know what to make of it, but it is as though both my blood and powers are responding to this... presence. Whether it is good or evil, I cannot say.~
END

I_C_T GORODR1 35 C0SireneGORODR135
== C0SIR25J IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) GlobalGT("Chapter","GLOBAL",7)~ THEN ~What has become of your faith, that you would forsake your duty so easily? Even if <CHARNAME> would show mercy, will you even have the courage to face Helm?~
END

I_C_T GORCHR 0 C0SireneGORCHR0
== C0SIR25J IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) GlobalGT("Chapter","GLOBAL",7)~ THEN ~My blood churns at the mere sight of this creature, <CHARNAME>. Trust nothing it says.~
END

I_C_T GORCAR 15 C0SireneGORCAR15
== C0SIR25J IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) GlobalGT("Chapter","GLOBAL",7)~ THEN ~He may be a despicable man, <CHARNAME>, but he is defenseless now. Show him mercy.~
END
...
I_C_T GORDEMO 1 C0SireneImprisonedOneMet1
== C0SirenJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !GlobalGT("Chapter","GLOBAL",7)~ THEN ~We... we are not alone, <CHARNAME>. I do not know what to make of it, but it is as though both my blood and powers are responding to this... presence. Whether it is good or evil, I cannot say.~
END

I_C_T GORODR1 35 C0SireneGORODR135
== C0SirenJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !GlobalGT("Chapter","GLOBAL",7)~ THEN ~What has become of your faith, that you would forsake your duty so easily? Even if <CHARNAME> would show mercy, will you even have the courage to face Helm?~
END

I_C_T GORCHR 0 C0SireneGORCHR0
== C0SirenJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !GlobalGT("Chapter","GLOBAL",7)~ THEN ~My blood churns at the mere sight of this creature, <CHARNAME>. Trust nothing it says.~
END

I_C_T GORCAR 15 C0SireneGORCAR15
== C0SirenJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !GlobalGT("Chapter","GLOBAL",7)~ THEN ~He may be a despicable man, <CHARNAME>, but he is defenseless now. Show him mercy.~
END
