...
CHAIN IF WEIGHT #-1 ~Global("C0SireneHexxat","GLOBAL",2)~ THEN C0SirenJ C0hexxatconflict
~Hold, vampire. I will have a few words with you.~ [C0BLANK]
DO ~SetGlobal("C0SireneHexxat","GLOBAL",3)~
== HEXXATJ ~What is it, my friend?~
== C0SIRENJ ~Do not mock me, monster. I am no friend of yours.~
== HEXXATJ ~There is no need for such hostilities. We are allies now.~
== C0SIRENJ ~No. I do not consider you an ally. Were it not for <CHARNAME>, I would have ended your existence upon first sight.~
== HEXXATJ ~If <CHARNAME> trusts me, then perhaps it is in your best interest to do the same.~
== C0SIRENJ ~I will not trust a being without humanity nor compassion, and neither will I suffer your company. Draw steel.~
== HEXXATJ ~I'm not interested in fighting you, paladin.~
== C0SIRENJ ~Then there is only one alternative. <CHARNAME>, Either it goes or I do.~
END
	++ ~In that case, I'm afraid you'll have to leave, Sirene.~ EXTERN C0SirenJ C0hexxatconflict1
	++ ~Fine. Hexxat, you'll have to go.~ EXTERN HEXXATJ C0hexxatconflict2

CHAIN C0SirenJ C0hexxatconflict1
...
!Global("OHN_PLOT","GLOBAL",6)~ THEN BC0Siren C0SireneNeera1
...
== BC0Siren ~But you know that they will still be hunted. They cannot remain forever.~
...
== BC0Siren ~What will you do then?~
...
== BC0Siren ~They could leave together. 'Twould be safer to travel as a group, anyhow.~
...
== BC0Siren ~Of course I will help you, Neera. 'Tis as much my duty to protect them as yours.~
EXIT
...
== BC0Siren ~You deserve to be proud of yourself, Neera. You have done the best you could for the mages.~
== BNEERA ~Thanks. I feel all warm and fuzzy inside. Speaking of which, I'm starving.~
== BC0Siren ~(smile) 'Tis a pleasure to see how you have grown, my friend.~
...
== BC0Siren ~I have a little left... here, take it all.~
== BNEERA ~Mmm-mmm!~
...
== BC0Siren ~(laugh) Though I assume the wild magic would complicate things.~
...
== BC0Siren ~Do you see yourself ever truly setting down?~
...
!StateCheck("C0Sirene",CD_STATE_NOTVALID)
Global("C0SireneRasaad1","GLOBAL",0)~ THEN BC0Siren C0SireneRasaad1
...
== BC0Siren ~Is there anything I may do to help?~
== BRASAAD ~No, my friend. I do not wish for anyone to be burdened with my troubles, more than they already have.~
== BC0Siren ~I do not wish to see you waste away in your pain, Rasaad. Will nothing ease your mind?~
== BRASAAD ~Only revenge.~
== BC0Siren ~Revenge will not bring you peace, Rasaad.~
...
Global("C0SireneRasaad2","GLOBAL",0)~ THEN BC0Siren C0SireneRasaad2
...
== BC0Siren ~...of course. Your brother's monastery. I am sorry, Rasaad, I forgot.~
== BRASAAD ~Why do you bring this up, Sirene?~
== BC0Siren ~Forgive me, I had only hoped to bring up happier times. 'Twas shortsighted of me not to think of the worst moment of it.~
...
== BC0Siren ~(smile) 'Twould be my pleasure.~
EXIT
...
== BC0Siren ~Then I fear we are at an impasse. So long as I am Ilmater's servant, my duty is to shoulder the burden of others. Please, trust me on this.~
== BRASAAD ~...~
...
== BC0Siren ~I...~
== BC0Siren ~Forgive me, Rasaad. I was foolish and arrogant to ask... 'tis a greater burden than any I have known.~
...
GlobalGT("OHR_PLOT","GLOBAL",5)~ THEN BC0Siren C0SireneRasaad3
...
== BC0Siren ~Our efforts, Rasaad. The failure is all of ours.~
== BRASAAD ~No. You have done nothing wrong, my friend. That you would help me at all means more than I can say.~
== BC0Siren ~This is not the way I would prefer to help, however. What do you intend to do now?~
== BRASAAD ~Move onward. I have no other choice.~
== BC0Siren ~There is always a choice, Rasaad. Reconcile with your order. They need you, just as you need them.~
...
== BC0Siren ~I do not want to see you continue this self-destructive path of vengeance.~
