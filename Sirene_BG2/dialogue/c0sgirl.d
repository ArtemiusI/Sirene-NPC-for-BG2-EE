...
== C0SIRE2J ~Look at that young girl, <CHARNAME>. 'Tis rare to see a child at work with such a broad smile on her face.~
...
END
++ ~They certainly are. Would you like a flower, Sirene?~ EXTERN C0SIRE2J girl3
++ ~I'm not interested in buying flowers.~ EXTERN C0SGIRL girl0

CHAIN C0SIRE2J girl3
...
== C0SIRE2J ~I- I appreciate it, but there is certainly no need for that.~
END
++ ~Oh, hush. Just accept it as a gift from me.~ EXTERN C0SGIRL girl4
++ ~What's the matter, Sirene? Do you not like flowers?~ EXTERN C0SIRE2J girl5
...
++ ~What do you think, Sirene? What kinds of flower do you like best?~ EXTERN C0SIRE2J girl7
++ ~On second thought, I'd rather not buy any flowers.~ EXTERN C0SGIRL girl0

CHAIN C0SIRE2J girl5
...
DO ~EscapeArea()~ EXTERN C0SIRE2J girl12
...
CHAIN C0SIRE2J girl12
~You really did not need to... I mean, I appreciate it, truly, but... you are giving me far more than I deserve, <CHARNAME>.~
END
+ ~!Global("C0SireneRomanceActive","GLOBAL",1) !Global("C0SireneRomanceActive","GLOBAL",2)~ + ~Really? I think this flower suits you perfectly.~ DO ~SetGlobal("C0SireneRomanceActive","GLOBAL",1)~ EXTERN C0SIRE2J girl13
+ ~!Global("C0SireneRomanceActive","GLOBAL",1) !Global("C0SireneRomanceActive","GLOBAL",2)~ + ~I gave you a gift, because I like you. Is that so wrong?~ DO ~SetGlobal("C0SireneRomanceActive","GLOBAL",1)~ EXTERN C0SIRE2J girl14
+ ~!Global("C0SireneRomanceActive","GLOBAL",1) !Global("C0SireneRomanceActive","GLOBAL",2)~ + ~Oh, you. Can't you just make do with a simple 'thank you' for once?~ DO ~SetGlobal("C0SireneRomanceActive","GLOBAL",1)~ EXTERN C0SIRE2J girl15
+ ~OR(2) Global("C0SireneRomanceActive","GLOBAL",1) Global("C0SireneRomanceActive","GLOBAL",2)~ + ~Really? I think this flower suits you perfectly.~ EXTERN C0SIRE2J girl13
+ ~OR(2) Global("C0SireneRomanceActive","GLOBAL",1) Global("C0SireneRomanceActive","GLOBAL",2)~ + ~I gave you a gift, because I like you. Is that so wrong?~ EXTERN C0SIRE2J girl14
+ ~OR(2) Global("C0SireneRomanceActive","GLOBAL",1) Global("C0SireneRomanceActive","GLOBAL",2)~ + ~Oh, you. Can't you just make do with a simple 'thank you' for once?~ EXTERN C0SIRE2J girl15

CHAIN C0SIRE2J girl13
~'Tis good of you to say so... either way, it *is* very beautiful.~
END
IF ~OR(2) Global("C0SireneRomanceActive","GLOBAL",1) Global("C0SireneRomanceActive","GLOBAL",2)~ EXTERN C0SIRE2J girl15
IF ~!Global("C0SireneRomanceActive","GLOBAL",1) !Global("C0SireneRomanceActive","GLOBAL",2)~ EXTERN C0SIRE2J girl16

CHAIN C0SIRE2J girl14
~No, certainly not. I appreciate it, truly.~
END
IF ~OR(2) Global("C0SireneRomanceActive","GLOBAL",1) Global("C0SireneRomanceActive","GLOBAL",2)~ EXTERN C0SIRE2J girl15
IF ~!Global("C0SireneRomanceActive","GLOBAL",1) !Global("C0SireneRomanceActive","GLOBAL",2)~ EXTERN C0SIRE2J girl16

CHAIN C0SIRE2J girl15
~...thank you, <CHARNAME>.~
EXIT

CHAIN C0SIRE2J girl16
~Though I... did not know you felt this way about me, <CHARNAME>. Though this is certainly not unwelcome. I wonder if, from now on...~
EXTERN C0SIRE2J girl15