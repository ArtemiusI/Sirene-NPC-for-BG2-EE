...
== C0SIRE2J ~Fallen? What do you mean by that, brother?~
== C0SCLER1 ~Hm? You wear the symbol of Ilmater, but I do not recognize your face.~
== C0SIRE2J ~Oh. Forgive me... I am Sirene, of the Holy Order of Suffering. 'Tis a pleasure to meet you, revered brother.~
== C0SCLER1 ~You are a knight of the order? Hm-hm, it is good that they continue to thrive. I was once of the order as well.~
== C0SIRE2J ~Truly? Then you are by all rights my superior, then. I trained under Sir Marc Morris of the order. Do you know of him, sir?~
...
== C0SIRE2J ~Yes, you said our church in Amn had fallen... what did you mean by that?~
...
END
+ ~OR(2) CheckStatGT(Player1,14,INT) CheckStatGT(Player1,14,WIS)~ + ~Is that so? How strange... for a faith that prides itself on selflessness and charity, that sounds suspiciously like a shakedown.~ EXTERN C0SIRE2J encounter6
+ ~Class(Player1,PALADIN_ALL)~ + ~Your words sound sincere, but there is something that doesn't add up... for some reason, the shadow of guilt hangs over you. You are lying, brother Daeron.~ EXTERN C0SIRE2J encounter6
+ ~OR(2) Class(Player1,THIEF_ALL) Class(Player1,BARD_ALL)~ + ~Oh, quit being ridiculous. Any rogue could recognize this scene for what it really is. It's clearly a shakedown!~ EXTERN C0SIRE2J encounter6
++ ~I see. Well, you may carry on, then. Good journey to you.~ EXTERN C0SCLER3 encounter7

CHAIN C0SIRE2J encounter6
...
== C0SIRE2J ~Is... is what this man saying true, brother?~
END
...
== C0SIRE2J ~Then... you are not truly a follower of Ilmater as you claimed to be?~
...
== C0SIRE2J ~Desperate enough to rob innocents, betraying those that we pledge our service to? You are mad!~
...
END
++ ~They understood, or did you beat that understanding into them?~ EXTERN C0SIRE2J encounter9
++ ~You're actually trying to defend your actions? You disgust me.~ EXTERN C0SIRE2J encounter9
++ ~How pathetic. You're desperately grabbing at straws, now that your life hangs on the balance. We should just kill them all, Sirene.~ EXTERN C0SIRE2J encounter9

CHAIN C0SIRE2J encounter9
...
== C0SIRE2J ~You would accept your fate so easily for their sakes?~
...
== C0SIRE2J ~I...~
== C0SIRE2J ~I do not know what to do, <CHARNAME>. My duty demands I do as the revered brother asks... but 'tis a difficult decision to make. I ask for your thoughts on this, as a leader and friend.~
END
++ ~There is still some honor in this one. Execute him, but let the others live. They should get a chance to redeem themselves.~ DO ~IncrementGlobal("C0SireneFaith","GLOBAL",-1)~ EXTERN C0SIRE2J encounter10
+ ~CheckStatGT(Player1,16,CHR)~ + ~Regardless of their intentions, they still knowingly abused their positions to rob others. None of them deserve to live.~ DO ~IncrementGlobal("C0SireneFaith","GLOBAL",-4)~ EXTERN C0SIRE2J encounter11
+ ~CheckStatLT(Player1,17,CHR)~ + ~Regardless of their intentions, they still knowingly abused their positions to rob others. None of them deserve to live.~ DO ~IncrementGlobal("C0SireneFaith","GLOBAL",-1)~ EXTERN C0SIRE2J encounter0
+ ~CheckStatGT(Player1,14,CHR)~ + ~Let them go, Sirene. They'll get what they deserve sooner or later.~ DO ~IncrementGlobal("C0SireneFaith","GLOBAL",-2)~ EXTERN C0SIRE2J encounter12
+ ~CheckStatLT(Player1,15,CHR)~ + ~Let them go, Sirene. They'll get what they deserve sooner or later.~ DO ~IncrementGlobal("C0SireneFaith","GLOBAL",-1)~ EXTERN C0SIRE2J encounter0
++ ~This judgment isn't yours to make. These men should turn themselves in to the laws of the land.~ EXTERN C0SIRE2J encounter13
++ ~I'm itching for a good fight. We should just execute the lot of them.~ DO ~IncrementGlobal("C0SireneFaith","GLOBAL",-1)~ EXTERN C0SIRE2J encounter0

CHAIN C0SIRE2J encounter0
...
== C0SIRE2J ~... ...Very well. Go in peace.~
END
...
== C0SIRE2J ~No, brother. Though it pains me to do his, you all must pay penance for your actions. Forgive us...~
...
++ ~I see there is no convincing you. Do what you must, Sirene.~ DO ~IncrementGlobal("C0SireneFaith","GLOBAL",-1)~ EXTERN C0SIRE2J encounter10
...
== C0SIRE2J ~Please... do not despair, brother. If you are truly faithful in Ilmater, then believe in his mercy. If you truly regret your actions, then this need not be the end for you.~
...
== C0SIRE2J ~I trust in your oath. May you find peace, brother, no matter what fate awaits you. Farewell.~
