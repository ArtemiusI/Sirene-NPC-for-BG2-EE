...
== C0SIRENJ ~I... I will remember your words, my lady. Thank you.~
EXIT
...
== C0SIRENJ ~Are you speaking to me, sir?~
== SALVANAS ~None other, sweet Ilmatari. Ah, I suffer, truly I do.~
== C0SIRENJ ~Do you suffer, truly? But I see no sign of such.~
...
== C0SIRENJ ~I am... unsure of what you speak.~
...
== C0SIRENJ ~...yes. Yes, they are. You were saying?~
...
== C0SIRENJ ~Excuse me, sir, but I was wondering if you had something... simpler?~
...
== C0SIRENJ ~Nay, sir. Do you have any of... *blush* ...romance?~
...
== C0SIRENJ ~I... I will not ask you to spend your gold for my sake, <CHARNAME>.~
END
+ ~PartyGoldGT(4)~ + ~What are you talking about? My gold is your gold. Here you go, merchant.~ DO ~TakePartyGold(5) GiveItemCreate("c0sbook","C0Sirene",0,0,0)~ EXTERN C0SIRENJ C0SireneBook1
+ ~PartyGoldGT(4) Global("C0SireneRomanceActive","GLOBAL",1)~ + ~Do you think I'd deny you anything? Here's the gold.~ DO ~TakePartyGold(5) GiveItemCreate("c0sbook","C0Sirene",0,0,0)~ EXTERN C0SIRENJ C0SireneBook1
+ ~PartyGoldGT(4) Global("C0SireneRomanceActive","GLOBAL",2)~ + ~Do you think I'd deny you anything, my love? Here's the gold.~ DO ~TakePartyGold(5) GiveItemCreate("c0sbook","C0Sirene",0,0,0)~ EXTERN C0SIRENJ C0SireneBook1
++ ~We've got more important things to spend our gold on.~ EXTERN C0SIRENJ C0SireneBook2
++ ~I'm not buying you a stupid book, Sirene. Let's get going.~ EXTERN C0SIRENJ C0SireneBook2

CHAIN C0SIRENJ C0SireneBook1
~You are too kind to me, <CHARNAME>. Thank you.~
== IMNBOOK1 ~A pleasure doing business with you, <PRO_SIRMAAM>. Have a pleasant day.~
EXIT

CHAIN C0SIRENJ C0SireneBook2
...
== C0SIRENJ ~B-but, I cannot take this! I have not paid...~
...
== C0SIRENJ ~I... I see. In that case, thank you, kind sir. I will treasure it greatly.~
...
== C0SIRENJ ~No, <PRO_HESHE> is not interested in such base and corrupt services. Begone from <PRO_HISHER> sight, fleshmonger, lest you live to regret it!~
EXTERN MADAM 17
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Yoshimo... no, it cannot be. You have *damned* yourself. What could drive you to do this?~
END

I_C_T YOSHIMOX 5 C0SireneYOSHIMOX5
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I see... so this is the suffering that binds your soul. In spite of all that has happened, Yoshimo, I am truly sorry that it must come to this.~
END

// Yoshimo's heart

INTERJECT SLILMAT 0 C0SireneSLILMAT0
== C0SIRENJ IF ~InParty("C0Sirene") Range("C0Sirene",15) !StateCheck("C0Sirene",CD_STATE_NOTVALID) PartyHasItem("miscbu")~ THEN ~Brother... I must ask a favor of you. I have here the heart of a lost friend. Before his death, he... asked lord Ilmater for judgment.~
EXTERN SLILMAT 10

I_C_T SLILMAT 10 C0SireneSLILMAT10
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~...<CHARNAME>?~
END

INTERJECT WILMAT 0 C0SireneWILMAT0
== C0SIRENJ IF ~InParty("C0Sirene") Range("C0Sirene",15) !StateCheck("C0Sirene",CD_STATE_NOTVALID) PartyHasItem("miscbu")~ THEN ~Sister... I must ask a favor of you. I have here the heart of a lost friend. Before his death, he... asked lord Ilmater for judgment.~
EXTERN WILMAT 4
...
== C0SIRENJ IF ~InParty("C0Sirene") Range("C0Sirene",15) !StateCheck("C0Sirene",CD_STATE_NOTVALID) !Global("C0SireneRomanceActive","GLOBAL",2)~ THEN
~Are you all right, my friend? Your face clearly shows discomfort.~
END
++ ~There's nothing wrong with me.~ EXTERN C0SIRENJ pl1.1
++ ~I'm fine. Just... a bit dizzy.~ EXTERN C0SIRENJ pl1.2
++ ~Something's not right. I think Irenicus did something to me.~ EXTERN C0SIRENJ pl1.3

CHAIN C0SIRENJ pl1.1
~Forgive me for saying so, <CHARNAME>, but I doubt that. If there is anything I can do to help, then tell me.~
EXIT

CHAIN C0SIRENJ pl1.2
...
END
++ ~I'm all right... really.~ EXTERN C0SIRENJ pl1.4
++ ~Something's wrong with me, Sirene, but I don't know what.~ EXTERN C0SIRENJ pl1.5
++ ~Let me hold you, Sirene. I need your support.~ EXTERN C0SIRENJ pl1.6

CHAIN C0SIRENJ pl1.4
~<CHARNAME>... please, do not lie to me. It does not make me feel better.~
EXIT

CHAIN C0SIRENJ pl1.5
~You are frightening me, <CHARNAME>. Perhaps it is this place... let us find a way out of here, quickly.~
EXIT

CHAIN C0SIRENJ pl1.6
...
== C0SIRENJ IF ~InParty("C0Sirene") See("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~By Ilmater, that... that *thing* was evil incarnate, <CHARNAME>. 'Twas like nothing I have ever seen before... was it your taint manifested?~
END
...
END
++ ~Sirene, this is between me and Irenicus. Your part in this is done.~ EXTERN C0SIRENJ pl2.1
++ ~There are many others who need you, Sirene. Don't throw away your life for me.~ EXTERN C0SIRENJ pl2.1
++ ~It's time to finish things. Are you prepared?~ EXTERN C0SIRENJ pl2.1

CHAIN C0SIRENJ pl2.1
...
DO ~SetGlobal("C0SireneTreeOfLife","GLOBAL",1)~
END
++ ~Sirene, I-~ EXTERN C0SIRENJ pl3.1

CHAIN C0SIRENJ pl3.1
...
== C0SIRENJ IF ~InParty("C0Sirene") Range("C0Sirene",15) !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Is this the end? It feels no different to me, but what of you, <CHARNAME>?~
END

// Hell

I_C_T PLAYER1 25 C0SireneEnteringHell1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Alignment("C0Sirene",LAWFUL_GOOD)~ THEN ~I... I thought I had seen the House of the Triad for a moment. 'Twas like a dream I never dared to imagine... but I heard your scream, so I turned away. Eternal rest seemed so close, yet... I stand at your side, <CHARNAME>, even in death.~
END

I_C_T PLAYER1 25 C0SireneEnteringHell2
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !Alignment("C0Sirene",LAWFUL_GOOD)~ THEN ~So, death was not the end for either of us... I thought perhaps this was the fate that awaited me, but... if I am to continue at your side even in this hell, then so be it.~
END

// Irenicus in hell

I_C_T HELLJON 7 C0SireneThirdBattleWithIrenicus1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Alignment("C0Sirene",LAWFUL_GOOD)~ THEN ~In Ilmater's name, you will pay for your sins, Irenicus. There will be no more mercy for you, from us or the gods!~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !Alignment("C0Sirene",LAWFUL_GOOD)~ THEN ~A thousand deaths are not enough penance for the sins you have committed, Irenicus. May your death be swift, for your final judgment will not!~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) OR(2) Global("C0SireneRomanceActive","GLOBAL",1) Global("C0SireneRomanceActive","GLOBAL",2)~ THEN ~<CHARNAME>... did you sleep at all? You look horribly pale...~
END
++ ~Get away from me, I'm turning!~ EXTERN C0SIRENJ C0SireneSecondSlayerChange1
++ ~It's coming again, Sirene! Run while you can!~ EXTERN C0SIRENJ C0SireneSecondSlayerChange1
++ ~I feel... strange...~ EXTERN C0SIRENJ C0SireneSecondSlayerChange1

CHAIN C0SIRENJ C0SireneSecondSlayerChange1
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) OR(2) Global("C0SireneRomanceActive","GLOBAL",1) Global("C0SireneRomanceActive","GLOBAL",2) Global("C0SireneSecondSlayerChange","GLOBAL",1)~ THEN ~You... <CHARNAME>, are you...~
...
== C0SIRENJ ~I know what you intend, monster, but Ilmater will protect my soul. You will not have me.~
== BODHIAMB ~Your pitiful god cannot protect you, Sirene. Surely you feel the call of the darkness welcoming you...~
== C0SIRENJ ~No! I put my life in my lord's hands! <CHARNAME>, strike me down!~
END
++ ~(Do as she says)~ EXTERN C0SIRENJ C0SireneKidnap1
++ ~I... I can't!~ EXTERN BODHIAMB C0SireneKidnap2
++ ~(Do nothing)~ EXTERN BODHIAMB C0SireneKidnap2

CHAIN C0SIRENJ C0SireneKidnap1
~Thank you...~
DO ~ClearAllActions()
StartCutSceneMode()
...
== C0SIRENJ ~I will not harm <CHARNAME>, even if I must fall. I choose death in Ilmater's name!~
DO ~ClearAllActions()
StartCutSceneMode()
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~This is no ogre, <CHARNAME>. No evil creature, at the very least.~
END

I_C_T QUAYLE 1 C0SireneQUAYLE1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~(smile) Is this the same Quayle that you and I remember, <CHARNAME>?~
END

// Faldorn

I_C_T CEFALDOR 0 C0SireneCEFALDOR0
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~Faldorn?! Have you truly gone mad, druid? Even as I remember you, you had not sunk to such depths! Do you even recognize us?~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Be wary, <CHARNAME>. This woman wears an aura of evil like a cloak. I would disbelieve anything she says to us.~
END

I_C_T BODHI 6 C0SireneBODHI6
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I will not do this, <CHARNAME>, and I advise you not to trust a word this... this thing says.~
END

I_C_T BODHI 18 C0SireneBODHI18
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I will have nothing to do with this creature, <CHARNAME>! Forgive me, but despite our friendship, this is where we part. Farewell.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Do not believe these lies, <CHARNAME> Even the Shadow Thieves are but flesh and blood, but she is a being of pure evil, and our enemy. She cannot be trusted.~
END

I_C_T C6BODHI 0 C0SireneC6BODHI0
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Your evil ends here, Bodhi, I swear in Ilmater's name.~
END

// Docks District

I_C_T2 DCLERIC 1 C0SireneDCLERIC1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~In the name of Ilmater, your madness ends this day!~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~'Twas a mistake allowing him to walk away, <CHARNAME>. Cyric's madmen are as cruel as they are mad, and will only sow discord so long as they are allowed to live.~
END

I_C_T2 MAEVAR 25 C0SireneMAEVAR25
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~Edwin... not a name I had hoped to hear again.~
END

I_C_T2 MAEVAR 31 C0SireneMAEVAR31
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~We have already been forced into one murder, <CHARNAME>. I do not wish to be a part of another.~
END

I_C_T EDWIN 1 C0SireneEDWIN1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~I had hoped never to meet you again since we parted, Red Wizard, though I should not be surprised that you work amongst such villains.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~*sigh* Once again, to work with thieves... let us be done with this distasteful mission as quickly as possible.~
END

I_C_T RENAL 30 C0SireneRENAL30
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~*sigh* Working with thieves... I do not like this. Let us be done with this distasteful mission as quickly as possible.~
END

I_C_T ARAN 0 C0SireneARAN0
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~The Shadowmaster himself... he is not as I expected, though perhaps appearances deceive.~
END

I_C_T ARAN 51 C0SireneARAN51
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Our task is a matter of life and death, and you think that these trinkets will satisfy? Do not mock us, thief.~
END

I_C_T LYROS 11 C0SireneLYROS11
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~I had hoped we'd seen the last of this mad necromancer when we parted ways with him.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I know we have important matters, <CHARNAME>, but we should bring him to aid imminently. His condition will get worse with every moment spent untreated.~
END

I_C_T2 RENFELD 8 C0SireneRENFELD8
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You cannot be so cruel, <CHARNAME>! He is suffering greatly and will die a painful death if we do not help him.~
END

I_C_T JAHEIRAJ 34 C0SireneJAHEIRAJ34
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Gods, Jaheira, you are becoming more pale as you speak. What did he do to you? How do you feel?~
== JAHEIRAJ ~I... I am alright, for the moment. But the bastard...~
END

I_C_T2 DLOST 0 C0SireneDLOST0
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Oh, poor child... is there anything we can do, <CHARNAME>?~
END

I_C_T2 DLOST 3 C0SireneDLOST3
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~That was cruel, <CHARNAME>. The girl was in desperate need of help, not your callousness.~
END

// Slums District

I_C_T2 LEHTIN 10 C0SireneLEHTIN10
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~A foul man... his tone is as treacherous as that of a snake. I fear nothing good lies behind those doors.~
END

I_C_T HENDAK 1 C0SireneHendak1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I should not be surprised that this den indulges in slavery. We must put an end to it, <CHARNAME>.~
END

I_C_T HENDAK 40 C0SireneHendak40
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Perhaps 'tis for the best, though I fear 'twould only draw further attention from the slavers. You should be wary, Hendak.~
== HENDAK ~You speak the truth, my friend, though I know well the risks, and I do not fear them.~
END

I_C_T SLAVERM 0 C0SireneSLAVERM0
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~What is this? The local law would knowingly turn a blind eye to this devilry?~
END

I_C_T HENDAK 31 C0SireneHendak31
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~As will we, whereever we find them. You have our promise of that.~
END

I_C_T LISSA 4 C0SireneLISSA4
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~How disgusting... children are the gods' gift to be cherished. Such abuse is only worthy of punishment.~
END

INTERJECT GIRL1 0 C0SireneGIRL1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~No, child, do not fear. You are free now. Go to Ilmater's temple. You will be safe there, I promise.~
EXTERN GIRL1 1

INTERJECT HAEGAN 0 C0SireneHAEGAN0
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Your slaving days are at an end, monster.~
EXTERN HAEGAN 2

I_C_T GIRL2 0 C0SireneGIRL20
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~The fiends... leaving this poor child with those beasts. 'Tis a miracle that we managed to save her, at least.~
END

INTERJECT GIRL2 4 C0SireneGIRL2
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Wait! Here, child... these are all the coins I have. I am sorry 'tis not much... but for food and shelter, it should suffice... keep it hidden, and stay safe.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~No, you will not escape your punishment so easily, murderer. Face justice!~
DO ~Attack("llynis")~
EXTERN LLYNIS 10
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~'Tis a restless spirit... but I sense no malice from him, only sorrow. Do not harm him, <CHARNAME>.~
END

I_C_T WELLYN 3 C0SireneWELLYN3
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Unthinkable... only a fiend could possibly murder and innocent child. We must help this one.~
END

I_C_T TIRDIR 2 C0SireneTIRDIR2
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Buried alive... a fate worse than death itself. Who could have done such a thing?~
END

I_C_T SETHLE 6 C0SireneSETHLE6
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Do not lie to us, you scoundrel! We know of the man you helped bury alive!~
END

I_C_T2 BHCRYPT 0 C0SireneBHCRYPT0
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Return to your grave, foul unliving beast!~
END

// Bridge District

I_C_T TANNER 8 C0SireneTanner8
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~We have no intention of leaving, not until we make you pay for what you have done.~
END

I_C_T INSPECT 13 C0SireneINSPECT13
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~By Ilmater, such an act could not have been done by any sane mind...~
END

I_C_T RAELIS 44 C0SireneRAELIS37
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You... you are of another plane, are you not? Something in my blood can sense it.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~How terrible... forced against their wills to fight to the death. We have no option but to give them a merciful end.~
END

I_C_T2 KAYPAL01 3 C0SireneKAYPAL013
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You have strayed far from your path, and now you must face the consequences, sir Anarg. May the gods have mercy on your soul.~
END

I_C_T KAYPAL02 6 C0SireneKAYPAL026
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~This man... Reynald de Chatillon. He is still a man of honor, <CHARNAME>. I hope we will not need to slay him like the rest.~
END

I_C_T2 NEB 5 C0SireneNEB5
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~<CHARNAME>, 'tis the child-killer from Baldur's Gate! You shall face Ilmater's justice, monster!~
END

I_C_T2 ANOMENJ 129 C0SireneANOMENJ129
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~No! Anomen, you cannot do this!~
END

I_C_T YUSUF 2 C0SireneYUSUF2
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Why, Anomen? You have stained your hands with the blood of an innocent! How could you do such a thing?~
END

I_C_T HLSKULL 4 C0SireneHLSKULL4
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~A cruel fate it may be, <CHARNAME>, yet... something about this one's presence makes me wary. Perhaps 'tis not entirely undeserved.~
END

// Temple District

I_C_T DORN 18 C0SireneDORN18
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You cannot truly consider associating with this blackguard, <CHARNAME>.~
END

INTERJECT DORN 16 C0SireneDORN16
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Vile fiend... that you can say such things without a hint of regret...~
== DORN ~Silence, fool. My words are for your leader, not you.~
== C0SIRENJ ~My words will not be enough this day. Draw, you thrall of evil. I will end you for the sake of those who fell by your hand.~
END
++ ~I agree with Sirene. Your evil ways are at an end, Dorn.~ EXTERN DORN 8
++ ~Put your weapon away, Sirene. Dorn could make a valuable ally.~ EXTERN C0SIRENJ SireneDORN1
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~Do you not remember us, Garrick? 'Tis a shame... though he seems quite different. Whatever happened to him, I wonder?~
END
...
== C0SIRENJ ~I... I fear I have a rather hideous scar that gives me great shame to reveal, especially in the face of one as radiant as you, my lady. Excuse me...~
EXIT
...
DO ~SetGlobal("C0Sirene","LOCALS",1)~
== C0SIRENJ ~Oh... thank you, sir.~
EXIT

// Unseeing Eye

I_C_T2 CSGAAL 7 C0SireneCSGAAL7
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~This is utter blasphemy, <CHARNAME>! How could anyone believe such things?~
END

I_C_T HPRELATE 11 C0SireneHPRELATE11
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Long have I wished to see these halls with my own eyes, <CHARNAME>. 'Tis as glorious, nay, more than I expected. I would not have dared to tread here without your company.~
END

I_C_T2 HURGISF 4 C0SireneHURGISF4
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Remember, <CHARNAME>. Though those of evil intent may try to hide behind a guise, we have the power to see the truth in their hearts. Now is the time to use that power.~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~He has revealed his true colors... I hope that you understand the correct choice here, <CHARNAME>.~
END

I_C_T KAYL2 10 C0SireneKAYL210
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~'Tis a tragedy when one of our own chooses to abuse their position, though I fear that banishment only encourages them to stray further from the right.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I know not how far these men have fallen, <CHARNAME>, but 'tis still a discomforting thought to have to slay fellow paladins.~
END

I_C_T GAAL 6 C0SireneGAAL6
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~This is *foul*, <CHARNAME>. 'Tis crueller than even the churches of Loviatar and Talona.~
END

I_C_T2 GAAL 23 C0SireneGAAL23
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You will do naught but die, madman, and may your insanity end with your tormented life!~
END

I_C_T THESHAL 5 C0SireneTHESHAL5
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~He is losing control, <CHARNAME>. I do not savor the thought, but we must defend ourselves soon, I fear.~
END

I_C_T RIFTM01 0 C0SireneRIFTM010
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Strange... men, but not men, and neither are they undead. Are they guardians?~
== RIFTM01 ~Call us what you wish. It does not matter.~
END

I_C_T RIFTM01 14 C0SireneRIFTM0114
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Older than Ilmater himself... I cannot imagine how long these guardians have suffered for.~
END

I_C_T RIFTM01 21 C0SireneRIFTM0121
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Fear not, guardian. We have taken the device, 'tis true, but we mean no evil.~
END

// Government District

I_C_T TOLGER 75 C0SireneTOLGER75
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I do not trust this mage, <CHARNAME>. He may act civil, but he cannot hide his malevolent intent.~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~Viconia, here? I do not have fond memories of her, but to be burned alive out of mere prejudice... I would not stand by and allow this to happen, <CHARNAME>.~
END

I_C_T2 VICG1 4 C0SireneVICG12a
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~'Tis too cruel of a fate even for a drow, <CHARNAME>. We cannot allow this to happen.~
END

I_C_T VICONI 2 C0SireneVICONI2
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I have no love for worshippers of Shar, but after seeing what almost came to pass... if you wish for her to join us, <CHARNAME>, I would not object.~
END

I_C_T VICONI 11 C0SireneVICONI11
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~*sigh* I feel disgusted just watching, <CHARNAME>. Was this a fair end to her life, I wonder? I hope to never encounter the same fate. Let... let us be away from here, please.~
END

I_C_T ANOMENJ 150 C0SireneANOMENJ150
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I know you must feel great turmoil, Anomen, truly. Your sister's death was unjust, but thoughtless revenge is not the solution.~
END

I_C_T MARIA 5 C0SireneMARIA5
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~Gods, how terrible... I feel that we should leave them be in a matter this severe, but I fear for sir Keldorn...~
END

I_C_T KELDORJ 23 C0SireneKELDORJ23
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~There must be another way, sir. You cannot simply condemn your family to such a cruel fate! I know 'tis not your true desire.~
...
== C0SIRENJ ~Sir Keldorn, you cannot mean such a thing...~
END

// Umar Hills

I_C_T VALYGAR 43 C0SireneVALYGAR43
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I believe him, <CHARNAME>. He is a ranger, and would not have slighted the wizards without reason.~
END

I_C_T2 VALYGAR 28 C0SireneVALYGAR28
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~No! If you intend on killing this innocent man, <CHARNAME>, then I shall die alongside him!~
DO ~SetGlobal("C0SireneJoined","GLOBAL",0)
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Quite the share of troubles that plagues this humble village, <CHARNAME>. Whether it be ogres, witches or wolves, none could be of good intent.~
END

I_C_T2 UHOGRE01 15 C0SireneUHOGRE0115
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~'Tis a surprise to see such a thing, <CHARNAME>. I am inclined to believe they truly mean Imnesvale no harm, so I think 'twould be best to inform the mayor.~
END

INTERJECT MAZZY 6 C0SireneMAZZY6
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Wait, <CHARNAME>. I have sensed the evil of this place since we entered, and there is none within this noble one. Allow me to release her.~
EXTERN MAZZY 13

I_C_T MAZZY 13 C0SireneMAZZY13
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I believe she would make a valuable companion, <CHARNAME>, and I would like to have the company of a fellow knight.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~A-Ajantis? Aye, 'tis truly him... today is a dark day indeed. He was my friend and brother-in-arms, and we killed him.~
END

I_C_T GARREN 1 C0SireneGARREN1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1) !InParty("Keldorn") !StateCheck("Keldorn",CD_STATE_NOTVALID)~ THEN ~Gods, no... look closely, <CHARNAME>. This... this is Ajantis. My friend and brother-in-arms, slain by my own hand. What evil could have misled us into doing this?~
END

I_C_T2 TAZOK 3 C0SireneTAZOK3
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~We defeated you once, and we shall do it again!~
END

I_C_T2 FIRKRA02 25 C0SireneFIRKRA0225
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~In the name of Ilmater, and Ajantis and all who fell by your trickery, you will fall, dragon!~
END

I_C_T2 FIRKRA02 25 C0SireneFIRKRA0225
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) !Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~May Ilmater's blessing guide us to victory, <CHARNAME>. We shall end your evil and tyranny today, dragon!~
END

I_C_T FIRKRA02 29 C0SireneFIRKRA0229
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Please, do not consider this, <CHARNAME>. The man has suffered enough, do not take away from him what he has left.~
END

I_C_T2 FIRKRA02 32 C0SireneFIRKRA0232
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You... you foul betrayer! May you get the punishment you deserve!~
DO ~LeaveParty()
EscapeArea()
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~We should hear her out, <CHARNAME>. The distress in her tone is clear enough to me.~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~<CHARNAME>, did we not meet this one in Nashkel? He is certainly bothersome enough to be the same person.~
END

I_C_T TRSKIN02 10 C0SireneTRSKIN0210
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~We must help, <CHARNAME>. 'Tis the life of an innocent girl at stake.~
END

I_C_T TRSKIN02 15 C0SireneTRSKIN0215
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Gods, I had hoped to encounter the monster again, so that justice may be exacted, but... not like this.~
END

I_C_T MAZZYJ 58 C0SireneMAZZYJ58
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~If you would allow it, my friend, perhaps I could remain. Perhaps my healing powers may still be of use to your sister.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~The lives of innocents are not playthings for your amusement!~
END

I_C_T2 GPHIL01 3 C0SireneCPHIL013
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~True strength should be used to defend the weak, not oppress them. I cannot stand by and allow this to happen!~
DO ~Attack("gphil03")~
END
...
+ ~IsValidForPartyDialog("C0Sirene") Global("C0SirenePartyBG1","GLOBAL",1)~ + ~You should remember Sirene. Do you recognize her, Imoen?~ EXTERN C0SIRENJ C0SirenePPIMOEN0
END

CHAIN C0SIRENJ C0SirenePPIMOEN0
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~This is disgusting, <CHARNAME>. We cannot stand by and allow this tyranny to continue.~
END

I_C_T PIRMUR01 2 C0SirenePIRMUR012
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Your thugs are no more, witch. I suggest you surrender and hand over Claire now lest you force our hand.~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~By Ilmater, they have even incarcerated children? What kind of monsters would do such a thing?~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~Does he seem familiar to you, <CHARNAME>? Something about his ramblings reminds me of...~
END

I_C_T PPSAEM2 0 C0SirenePPSAEM20
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You again? Your face was not one that I had wished to see after the tedious travel through that maze.~
== PPSAEM2 ~Perhaps what I am about to say might change your mind, my lady.~
END

I_C_T PPSAEM2 19 C0SirenePPSAEM219
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~To traverse through the Underdark or put our trust in this scoundrel... I cannot say I am fond of either prospect.~
END

I_C_T2 IMOEN2 22 C0SireneIMOEN222
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~<CHARNAME>, no. You cannot abandon her, not when she has suffered through such a terrible ordeal.~
== C0SIRENJ ~Leave me instead. I can fend for myself. Imoen needs you far more than you need me.~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~'Tis as though he is sizing us up for his next meal, <CHARNAME>. I do not like this.~
END

I_C_T SAHKNG01 36 C0SireneSAHKNG0136
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I would not put it past these shark-fiends to turn against us once we served their purpose, <CHARNAME>.~
END

I_C_T SAHPR4 4 C0SireneSAHPR44
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~A frightening prospect... I can only hope that their kind's arrogance betrays them in the future.~
END

// Underdark 

I_C_T UDSVIR03 23 C0SireneUDSVIR0323
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~We would help, even if you had nothing to give us in exchange.~
END

I_C_T UDSILVER 0 C0SireneUDSILVER0
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Oh... oh, my.Å She is so beautiful... I cannot even describe it.~
END

I_C_T UDSILVER 53 C0SireneUDSILVER53
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~'Tis like trading the blood of one fiend for another, <CHARNAME>. I cannot tell you which feels worse.~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I dislike this, <CHARNAME>. Despite his hostility, Solaufein has been more than fair to us compared to the rest of these fiends. Perhaps we could warn him and find another way.~
END

I_C_T2 UDSOLA01 132 C0SireneUDSOLA01132
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~A follower of the Dark Maiden, here... he is a braver man than I thought. 'Tis a good thing that we did not need to kill him.~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~His mind must have been broken by his imprisonment, <CHARNAME>, but perhaps it can be mended. Violence may not be the only way!~
END

I_C_T UDILSLA2 0 C0SireneUDILSLA20
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You are welcome, friends, though I am curious as to why you are here, of all places.~
END

// Coran

I_C_T C6CORAN 1 C0SireneC6CORAN1
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID) Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~(laugh) 'Tis more likely you were overly preoccupied with female attention to care to seek us out, Coran.~
...
== C0SIRENJ ~You have not changed one bit, Coran... unfortunately.~
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~*sigh* By Ilmater, will it ever stop?~
END

I_C_T SUELF4 0 C0SireneC6ELF40
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Shh... fear not, children. We are friends, not monsters.~
END
...
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~'Twas not enough, that much is clear, and 'twould seem your kin must share the blame for <CHARNAME>'s current condition.~
END

I_C_T SUDEMIN 32 C0SireneSUDEMIN32
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Though the issue of your lost soul is paramount, <CHARNAME>, we cannot just watch the city suffer.~
END

I_C_T2 SUJON 14 C0SireneSUJON14
== C0SIRENJ IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~You have caused too many to suffer, and I will not rest until the blight of your existence has ended!~
END

// TALKS START HERE

CHAIN IF WEIGHT #-1 ~Global("C0SireneBG1Talk","GLOBAL",2)~ THEN C0SIRENJ t0
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",2)~ THEN C0SIRENJ t1
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",4)~ THEN C0SIRENJ t2
...
!Class(Player1,RANGER_ALL)~ THEN C0SIRENJ t3
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",8)~ THEN C0SIRENJ t4
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",10)~ THEN C0SIRENJ t5
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",12)~ THEN C0SIRENJ t6
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",14)~ THEN C0SIRENJ t7
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",16)~ THEN C0SIRENJ t8
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",18)~ THEN C0SIRENJ t9
...
CHAIN IF ~Global("C0SireneFriendshipTalk","GLOBAL",20)~ THEN C0SIRENJ t10
...
CHAIN IF ~Global("C0SireneFriendshipHellTalk","GLOBAL",2)~ THEN C0SIRENJ t11
~<CHARNAME>?~ [C0BLANK]
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",2)~ THEN C0SIRENJ lt1
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",4)~ THEN C0SIRENJ lt2
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",6)~ THEN C0SIRENJ lt3
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",8)~ THEN C0SIRENJ lt4
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",10)~ THEN C0SIRENJ lt5
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",12)~ THEN C0SIRENJ lt6
~It has just occurred to me that... I have not been the most forthcoming with my past, <CHARNAME>.~ [C0BLANK]
== C0SIRENJ IF ~Global("C0SirenePartyBG1","GLOBAL",1)~ THEN ~We have been friends for some time, yet I have only told you of my early childhood, as I recall.~
== C0SIRENJ ~Perhaps you may be interested in knowing more of me. I feel that may... be necessary to build trust between us. Would you like that?~
DO ~IncrementGlobal("C0SireneLovetalk","GLOBAL",1)
RealSetGlobalTimer("C0SireneLovetalkTimer","GLOBAL",2700)~
END
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",14)~ THEN C0SIRENJ lt7
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",16)~ THEN C0SIRENJ lt8
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",18)~ THEN C0SIRENJ lt9
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",20)~ THEN C0SIRENJ lt10
...
DO ~IncrementGlobal("C0SireneLovetalk","GLOBAL",1)
RealSetGlobalTimer("C0SireneLovetalkTimer","GLOBAL",2700)~
== C0SIRENJ IF ~!Class(Player1,RANGER_ALL) !Class(Player1,DRUID_ALL)~ THEN ~What do you think, <CHARNAME>? Are you at home in such a place?~
== C0SIRENJ IF ~Class(Player1,RANGER_ALL)~ THEN ~You are a ranger, <CHARNAME>. I cannot imagine you are any more fond of this place as I am. Or am I wrong to assume such?~
== C0SIRENJ IF ~Class(Player1,DRUID_ALL)~ THEN ~You are a druid, <CHARNAME>. I cannot imagine you are any more fond of this place as I am. Or am I wrong to assume such?~
END
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",22) !Global("C0SireneUmarLovetalk","GLOBAL",1)~ THEN C0SIRENJ lt11
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",22) Global("C0SireneUmarLovetalk","GLOBAL",1)~ THEN C0SIRENJ lt11a
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",24)~ THEN C0SIRENJ lt12
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",26)~ THEN C0SIRENJ lt13
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",28)~ THEN C0SIRENJ lt14
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",30)~ THEN C0SIRENJ lt15
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",32)~ THEN C0SIRENJ lt16
...
CHAIN IF ~Global("C0SireneLovetalk","GLOBAL",34)~ THEN C0SIRENJ lt17
...
CHAIN IF ~Global("C0SireneUstNathaLovetalk","GLOBAL",1)~ THEN C0SIRENJ lt18
...
CHAIN IF ~Global("C0SireneSleepLovetalk","GLOBAL",1)~ THEN C0SIRENJ lt19
...
CHAIN IF ~Global("C0SireneAfterSleep","GLOBAL",1)~ THEN C0SIRENJ lt20
...
CHAIN IF ~Global("C0SireneChapter5","GLOBAL",1)~ THEN C0SIRENJ c5
...
CHAIN IF WEIGHT #-1 ~Global("C0SireneCarsomyr","GLOBAL",1)~ THEN C0SIRENJ C0SireneCarsomyr
...
IF ~IsGabber(Player1) Global("Chapter","GLOBAL",5)~ C0SirenePIDUnderdark
...
CHAIN IF WEIGHT #-1 ~Global("C0SireneLowRep","GLOBAL",1)~ THEN C0SIRENJ C0SireneRep01
...
CHAIN IF WEIGHT #-1 ~Global("C0SireneRepBreak","GLOBAL",1)~ THEN C0SIRENJ C0SireneRep02
...
CHAIN
IF ~Global("C0SireneViconiaRest","GLOBAL",2)~ THEN C0SIRENJ C0SireneViconia2
...
== C0SIRENJ ~'Tis the remainder of the yesterday's stew, Viconia. You seemed to appreciate it then.~
== BVICONI ~Clearly it has not aged well. The very scent offends me. Take it away.~
== C0SIRENJ ~If you truly hate me so much, Viconia, then simply say so. There is no need to taunt me like this.~
== BVICONI ~Oh? Am I truly so transparent? Clearly I must learn to mask my feelings more carefully.~
== C0SIRENJ ~Take the food or leave it, Viconia. I am simply looking out for you.~
...
== C0SIRENJ ~I have had enough of this. Starve to death, Viconia, if that is what you'd prefer. I will remember to do you no more favors.~
EXIT
...
+ ~Global("Chapter","GLOBAL",2)~ + ~What do you think of our quest?~ + chapter2
+ ~Global("Chapter","GLOBAL",3) Global("C0SirenePartyBG1","GLOBAL",1)~ + ~What do you think of our quest?~ + chapter3a
+ ~Global("Chapter","GLOBAL",3) !Global("C0SirenePartyBG1","GLOBAL",1)~ + ~What do you think of our quest?~ + chapter3b
+ ~Global("Chapter","GLOBAL",4)~ + ~What do you think of our quest?~ + chapter4
+ ~Global("Chapter","GLOBAL",6)~ + ~What do you think of our quest?~ + chapter6
+ ~Global("Chapter","GLOBAL",7)~ + ~What do you think of our quest?~ + chapter7
