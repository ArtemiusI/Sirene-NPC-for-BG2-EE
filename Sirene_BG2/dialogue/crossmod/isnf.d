...
== C0SIRE2J IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~I... I feel as though we have intruded upon something private, <CHARNAME>.~
END

I_C_T ISNFXOR 121 C0SireneISNFXOR121
== C0SIRE2J IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~No... master Orion, you cannot say such a thing...!~
END

I_C_T ISNFXEN 0 C0SireneISNFXEN0
== C0SIRE2J IF ~InParty("C0Sirene") InMyArea("C0Sirene") !StateCheck("C0Sirene",CD_STATE_NOTVALID)~ THEN ~Gods, what a horrifying creature. And yet its form reminds me of the avatar of lord Ilmater's avatar in a way, tortured and in suffering. Perhaps 'tis more than a mere undead beast.~
END
